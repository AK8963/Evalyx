"""
Configuration settings for TraceIQ backend.
...
class Settings(BaseSettings):
    ...
    # API Settings
    API_TITLE: str = "TraceIQ Open Source"
    ...
    SMTP_FROM_ADDRESS: str = os.getenv("SMTP_FROM_ADDRESS", "alerts@traciq.local")
    SMTP_FROM_NAME: str = os.getenv("SMTP_FROM_NAME", "TraceIQ Alerts")
